...
def main(args, criterion):
    ...
    dataset_train = build_dataset(is_train='Processed_metadata.csv', args=args)
    dataset_val = build_dataset(is_train='Processed_metadata.csv', args=args)
    dataset_test = build_dataset(is_train='Processed_metadata.csv', args=args)
    ...
    if args.eval:
        ...
        test_stats, auc_roc = evaluate(data_loader_test, model, device, args, epoch=0, mode='external_test',
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        if epoch == (args.epochs - 1):
            checkpoint = torch.load(os.path.join(args.output_dir, args.task, 'checkpoint.pth'), map_location='cpu')
