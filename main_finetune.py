...
def main(args, criterion):
    ...
    if args.finetune and not args.eval:
        ...
        checkpoint_path = './RETFound_dinov2_meh.pth'
    ...
    dataset_train = build_dataset(is_train='train.csv', args=args)
    dataset_val = build_dataset(is_train='val.csv', args=args)
    dataset_test = build_dataset(is_train='test.csv', args=args)
